...
import CommentInfoDrawer from '../../comment/components/CommentInfo';
    ...
    <>
      <Stack key={comment._id} direction="row" spacing={1} mt={2}>
        ...
        <Paper sx={{ width: '100%', backgroundColor: 'inherit' }} variant="elevation">
          ...
          <Typography mx={1} mb={1} variant="subtitle2" fontWeight={200} color="textSecondary">
            {comment.comment}
          </Typography>
        </Paper>
      </Stack>
