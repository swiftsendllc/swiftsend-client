...
import { Avatar, Box, Divider, IconButton, Skeleton, Stack, Typography, useMediaQuery, useTheme } from '@mui/material';
...
export function MessageThreadHeader({ loading }: { loading: boolean }) {
  ...
  return (
    <Box display="flex" justifyContent="space-between" alignItems="center" px={2} py={1} sx={{ minHeight: 64 }} borderBottom={"1px solid"}>
